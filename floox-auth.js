...
(() => {
  ...
  function loadScript(file,marker){if(document.querySelector(`script[data-${marker}]`))return;const s=document.createElement('script');s.src=file+'?v=20260818-3';s.async=false;s.dataset[marker]='1';document.head.appendChild(s)}
